                ...
                <div class="row">
                    ...
                    <div class="col-md-9 col-md-9" style="border: 1px solid #e1e6eb">
                        <div class="input-group m-b30">
                            <h2>Edit Company</h2>
                            <form method="POST" action="{{url('/update-company/'.$company->id)}}" id="editCompany">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    <button style="cursor:pointer;margin-top: 10px;" type="submit" class="btn btn-primary">Update Company</button>
                                    <a href="{{url('/company/show')}}"><button style="cursor:pointer;margin-top: 10px;" type="submit" class="btn btn-primary">Back</button></a>
                                </div>
                            </form>
                        </div>
                    </div>
